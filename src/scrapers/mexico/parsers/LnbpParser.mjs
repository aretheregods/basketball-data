/**
 * @file LnbpParser.mjs
 * @description Robust zero-dependency regex-based HTML parser for Proballers LNBP box score pages.
 */
...
/**
 * @description Parses raw Proballers HTML content into clean JSON matching Mexico BoxScore Schema.
 ...
 */
export function parseLnbpHtml(htmlContent, homeSlugExpected, awaySlugExpected, gameId, season) {
	...
	if (statsTables.length < 2) {
		throw new Error(`[DOM Error] Found fewer than 2 statistics tables for LNBP game ${gameId}.`);
	}
