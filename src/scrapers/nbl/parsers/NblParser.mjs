/**
 * @file NblParser.mjs
 * @description Robust zero-dependency regex-based HTML parser for Proballers NBL box score pages.
 */
...
/**
 * @description Parses raw Proballers HTML content into clean JSON matching NBL BoxScore Schema.
 ...
 */
export function parseNblHtml(htmlContent, homeSlugExpected, awaySlugExpected, gameId, season) {
	...
	if (statsTables.length < 2) {
		throw new Error(`[DOM Error] Found fewer than 2 statistics tables for NBL game ${gameId}.`);
	}
